var apiUrl = 'http://47.244.9.84:8080/api/v1';
// 永续基金
var buyFund = apiUrl + '/fund/buyFund',
...
// OTC userId = 10119
var addBank = apiUrl + '/otc/addBank', // 添加到账银行卡
...
// 我的店铺
var confirmAgree = apiUrl + '/shop/confirmAgree/', // 店铺确认同意{id}
